...
public class SystemController {
    ...
    @ApiOperation("列出所有用户")
    @RequestMapping(value = "queryDeptManagers", method = RequestMethod.GET)
    @ResponseBody
    public List<UserRole> listUsers(@RequestBody(required = false)
                                            Permission permission) {
        List<UserRole> users = systemservice.getAllUsersByPerm(permission);
        return users;
    }
}
